...
class EntityDefinition:
    ...
    @staticmethod
    def from_dict(data: Dict[str, Any]) -> 'EntityDefinition':
        return EntityDefinition(
            name=str(data.get('name', 'entity_1')),
            sprite_path=str(data.get('sprite_path', '')),
            custom_fields={
                str(k): str(v)
                for k, v in dict(data.get('custom_fields', {})).items()
            },
        )
...
class Project:
    ...
    def from_dict(data: Dict[str, Any]) -> 'Project':
        ...
        return Project(
            ...
            entities=[EntityDefinition.from_dict(entity) for entity in raw_entities],
        )
